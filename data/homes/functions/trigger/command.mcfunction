...
#help command
execute store success score unnormalCommand homes if score triggerHelp homes matches 1 run function homes:commands/help/help
#give book
execute store success score unnormalCommand homes if score homeId homes matches 1 unless score triggerListhomes homes matches 1 unless score triggerHelp homes matches 1 run function homes:book/give_book
#change the text color
execute store success score unnormalCommand homes if score triggerListhomes homes matches 1 if score homeId homes matches -32..-1 run function homes:trigger/set_color
#click event
execute store success score unnormalCommand homes if score triggerListhomes homes matches 1 if score homeId homes matches ..-34 run function homes:trigger/click_event
