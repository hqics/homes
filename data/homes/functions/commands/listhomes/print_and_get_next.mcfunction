...
tellraw @s {"hoverEvent":{"action":"show_text","contents":[{"nbt":"data.homes.color0","storage":"entitydb:","interpret":true},{"text":"Click to teleport."}]},"nbt":"data.homes.color0","storage":"entitydb:","interpret":true,"extra":[{"nbt":"click_events[0]","storage":"homes:click_events","interpret":true,"extra":[{"nbt":"data.homes.color1","storage":"entitydb:","interpret":true,"extra":[{"nbt":"data.homes.homelist[-1].id","storage":"entitydb:","interpret":true}]}," in ",{"nbt":"data.homes.homelist[-1].Dimension","storage":"entitydb:"}," at ",{"score":{"name":"x","objective":"homes"}}," ",{"score":{"name":"y","objective":"homes"}}," ",{"score":{"name":"z","objective":"homes"}}]}]}
