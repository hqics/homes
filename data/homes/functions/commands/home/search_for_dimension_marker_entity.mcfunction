execute if entity @e[tag=homes.dimension] run say this is wigged
...
execute if score found homes matches 1 in entitydb: positioned 0 0 0 run function homes:commands/home/summon_temp_entity
