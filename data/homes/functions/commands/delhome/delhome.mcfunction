...
execute if score not_found entitydb matches 0 run tellraw @s {"extra":["Deleted home ",{"nbt":"home_data","storage":"homes:","interpret":true}],"nbt":"data.homes.color0","storage":"entitydb:","interpret":true}
