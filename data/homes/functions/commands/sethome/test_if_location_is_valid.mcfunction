...
execute if score locationValid homes matches 0 run tellraw @s [{"nbt":"data.homes.color0","storage":"entitydb:","interpret":true},"Invalid location. Your y-coordinate needs to be in [-20000000,20000000)."]
