...
execute if score triggerListhomes homes matches 1 if score homeId homes matches -32..-1 run function homes:set_color
execute if score triggerListhomes homes matches 1 if score homeId homes matches ..-33 run function homes:click_event
execute if score c homes matches 1 run function homes:command_
